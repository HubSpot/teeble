...
this.Teeble.TableView = (function(_super) {
  ...
  function TableView() {
    this.sortByDescending = __bind(this.sortByDescending, this);

    this.sortByAscending = __bind(this.sortByAscending, this);
  ...
  TableView.prototype.renderHeader = function() {
    ...
    return this.table.append(this.header.render().el);
  };
  ...
  TableView.prototype.sortByAscending = function(e) {
    return this._sort(e, 'asc');
  };

  TableView.prototype.sortByDescending = function(e) {
...
this.Teeble.ClientCollection = (function(_super) {
  ...
  ClientCollection.prototype.initialize = function() {
    ...
    this.paginator_core = _.extend({}, this.default_paginator_core, this.paginator_ui);
