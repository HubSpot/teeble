    ...
    app.collections.paginatedItems.fetch({
        success: function(){
            ...
            app.views.table = new app.views.NetflixTable({
                ...
                partials: [
                    {
                        header: '<span class="tag">&lt;<span class="title">th</span> <span class="attribute">class</span>=<span class="value">"sorting"</span> <span class="attribute">data-sort</span>=<span class="value">"Name"</span>&gt;</span>Title<span class="tag">&lt;/<span class="title">th</span>&gt;</span>',
                        cell: "<span class="tag">&lt;<span class="title">td</span>&gt;</span><span class="variable">{{Name}}</span><span class="tag">&lt;/<span class="title">td</span>&gt;</span>"
                    },
                    {
                        header: '<span class="tag">&lt;<span class="title">th</span> <span class="attribute">class</span>=<span class="value">"sorting"</span> <span class="attribute">data-sort</span>=<span class="value">"Runtime"</span>&gt;</span>Runtime<span class="tag">&lt;/<span class="title">th</span>&gt;</span>',
                        cell: "<span class="tag">&lt;<span class="title">td</span>&gt;</span><span class="variable">{{RuntimeMinutes}}</span><span class="tag">&lt;/<span class="title">td</span>&gt;</span>"
                    },
                    {
                        header: '<span class="tag">&lt;<span class="title">th</span> <span class="attribute">class</span>=<span class="value">"sorting"</span> <span class="attribute">data-sort</span>=<span class="value">"ReleaseYear"</span>&gt;</span>Release Year<span class="tag">&lt;/<span class="title">th</span>&gt;</span>',
                        cell: "<span class="tag">&lt;<span class="title">td</span>&gt;</span><span class="variable">{{ReleaseYear}}</span><span class="tag">&lt;/<span class="title">td</span>&gt;</span>"
                    }
                ]
            });
