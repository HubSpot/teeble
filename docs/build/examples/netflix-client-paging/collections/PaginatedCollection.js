...
<pre><code>collections.PaginatedCollection = Teeble.ClientCollection.extend({
    ...
    paginator_ui: {
        ...
        perPage: <span class="number">30</span>,
    ...
    server_api: {
        ...
        '$top': function() { <span class="constant">return</span> this.totalPages * this.perPage; },
        ...
        '$skip': function() { <span class="constant">return</span> this.totalPages * this.perPage; },
