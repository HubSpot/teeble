...
<span class="char">$(</span>function(){
    ...
    app.collections.paginatedItems.fetch({
        <span class="method">success:</span> function(){
            ...
            <span class="char">$(</span><span class="string">'#content'</span>).html(app.views.table.render().el);
        }
    });
