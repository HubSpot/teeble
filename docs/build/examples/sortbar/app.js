    ...
    app.collections.paginatedItems.fetch({
        success: function(){
            ...
            app.views.table = new app.views.BrowserTableView({
                ...
                partials: [
                    {
                        header: '<span class="tag">&lt;<span class="title">th</span> <span class="attribute">class</span>=<span class="value">"sorting"</span> <span class="attribute">data-sort</span>=<span class="value">"name"</span>&gt;</span>Name<span class="tag">&lt;/<span class="title">th</span>&gt;</span>',
                        cell: "<span class="tag">&lt;<span class="title">td</span>&gt;</span><span class="vbscript">&lt;%= name %&gt;</span><span class="tag">&lt;/<span class="title">td</span>&gt;</span>"
                    }
                ]
            });
